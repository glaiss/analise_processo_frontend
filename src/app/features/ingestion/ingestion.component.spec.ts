...
describe('IngestionComponent', () => {
  ...
  it('should handle error on submit', () => {
    ingestionService.sincronizar.mockReturnValue(throwError(() => new Error('fail')));
    const fixture = TestBed.createComponent(IngestionComponent);
    fixture.componentInstance.onSubmit();
  ...
  it('should render the form', () => {
    ...
    expect(fixture.nativeElement.querySelector('form, mat-form-field, button')).toBeTruthy();
  });
});
